...
public class RedSquare {
	...
	private static final boolean drawBlueSquare = false;
	...
	public static void main(String[] args) {
		...
		if (drawBlueSquare || drewRedSquare) {
			JOptionPane.showMessageDialog(null, "Do you want to draw a square?");
		}
		...
		if(drewRedSquare || drewBlueSquare || drewBlueTriangle) {
